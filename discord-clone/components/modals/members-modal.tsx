...
// Member modal for viewing and managing members of a server.
    ...
    return ( 
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white text-black"
                >
                {/* Modal header with title and number of members */}
                ...
                {/* Scroll area containing all members with role, email, and actions */}
